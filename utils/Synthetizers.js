import { Synthetizer, CustomSynthetizer, FunctionSynthetizer } from './MIDI'
...
const synthetizers = [
  ...
  new CustomSynthetizer('Cheap Strings', {fadeTime: 0.7}, [0, 5, 1, -1.5, -1, -1.5, -1, -1.5, -1, 0, 0.5, 3, 1, 0, -0.5, -0.5, -0.5, -0.5, 0, 0.25, 0.5],
  new Int8Array(21), true),
